    ...
    var Comments = {
        ...
        options: {
            ...
            timeFormatter: function(time) {
                ...
                //Order if-conditions in order of likelihood. So new comments are timeformatted faster
                if (seconds < 5) {
                    return "just now";
                } else if (seconds < 60) {
                    ...
                    //2 days is a reasonable time for a user to think back to
                    ...
                    //Make the comment's date verbose
